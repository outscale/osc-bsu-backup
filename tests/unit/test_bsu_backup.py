...
class TestBsuBackup(unittest.TestCase):
    ...
    def test_find_instance_by_id(self):
        ...
        with Stubber(ec2) as stubber:
            stubber.add_response(
                "describe_instances", response, {"InstanceIds": ["i-e6b7ab04"]}
            )
    ...
    def test_find_volume_by_id(self):
        ...
        with Stubber(ec2) as stubber:
            stubber.add_response(
                "describe_volumes", response, {"VolumeIds": ["vol-a24fffdc"]}
            )
    ...
    def test_rotate_snapshots(self):
        ...
        with Stubber(ec2) as stubber:
            ...
            self.assertEqual(
                bsu.rotate_snapshots(ec2, ["vol-59b94d63", "vol-640141cf"], 8), None
            )
        ...
        with Stubber(ec2) as stubber:
            ...
            self.assertEqual(
                bsu.rotate_snapshots(ec2, ["vol-59b94d63"], -5487812), None
            )
    ...
    def test_create_snapshots(self):
        ...
        with Stubber(ec2) as stubber:
            ...
            self.assertEqual(
                bsu.create_snapshots(ec2, ["vol-56d30e10", "vol-640141cf"]), None
            )
